...
namespace RubiCool.MSCRM.Plugins
{
    ...
    /// Contact Plugin
    /// </summary>
    public class Contact : PluginBase
    {
        public Contact(string unsecure, string secure)
            : base(typeof(Contact))
        {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            switch (pluginStage)
            {
                case PluginStage.PostOperationCreate:
                    ContactPluginContextHelper.SendInvitation(localContext.OrganizationService,
                ...
                case PluginStage.PostOperationUpdate:
                    ContactPluginContextHelper.UpdateContact(localContext.OrganizationService,
                        localContext.TracingService, entity, preImageEntity);
                    break;
            }
        }
    }
